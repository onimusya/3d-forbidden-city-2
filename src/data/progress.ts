...
export const PROGRESS_HISTORY: ProgressEntry[] = [
  ...
  },
  {
    ...
    remainingGaps: ['Tune low-power WebGL framing and texture memory', 'Give completed trail seals a richer visual archive', 'Add a public gallery for shared moments'],
